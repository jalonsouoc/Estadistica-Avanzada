...
Para la pregunta definida, el contraste a aplicar es un contraste de dos muestras ya que por un lado tenemos la muestra de la variable IniCost y por el otro la muestra de la variable UltCost. El contraste se aplica sobre la media de la diferencia de ámbas variables y es un contraste bilateral.
...
pvalue <- pt(abs(tobs), lower.tail=FALSE, df=n-1)
...
c(mean1, mean2, sd1,sd2,n1,n2)
c(fobs,fcritL, fcritU, pvalor)
````
