...
Este modelo indica que por cada año de edad el salario anual aumenta en 0.082515 k euros, por cada año de formación el salario anual aumenta en 0.446817 k eruos, por cada hora de la semana trabajada el salario anual aumenta en 0.073834 euros y que para los trabajadores hombres el salario anual aumenta en 10.108404 k euros.

Vemos que este modelo tiene un coeficiente de determinación de 0.5892 lo que nos inddica que el modelo de regresión lineal explica el 58,92% de las observaciones.
...
Construimos el modelo de regresión lgística en base a las variables mencianadas anteriormente
...
Del modelo anterior podemos destacar que casi todas las variables poseen un coeficiente estadísticamente signidficativo para predecir los salarios de los individuos ya que obtenemos p-valores inferiores al 0,05 de significación definido. 

Tenemos excepciones dentro de algunas variables ya que el martial_status Separated no es significativo a la hora de predecir el salario anual, al igual que la occupation Other/Unknown ya uqe poseen p-valores superiores al 0.05 de significación. Lo mismo ocurre con las razas Asian-Pac_islander y Other.
...
De forma que la tabla final resularía
...
Obtenemos ahora la probabilidad de que el salario de un individuo sea menor de 50k€ para un hombre negro de 60 años de edad, con traajo gubernamental, con 15 años de estudios, casado, trabajando como "white collar" y trabajando unas 35 horas semanales.
...
Obtenemos que la probabilidad de que el salario sea menor de 50 k€ es de 0.3766705. Comprobamos el resutado con el función en R predict.
...
Podemos ver que para todas las ocupaciones el pico superior de salario anual se encuentra en la raza White y el pico inferior n la raza Other como habíamos visto en el apartado anterior. También podemos ver que la oocupación White-Collar es la que mayor salario anual posee para las razas Amer-Indian-Eskimo y Black sin embargo para Other y White es la ocupación Professional.

# 8 Conclusiones

Como conclusión de la práctica, hemos realizado la lectura y preparacdión de los datos para poder realizar los análisis correspondientes posteriormente, aunque los datos venían en un formato bastante correcto.
