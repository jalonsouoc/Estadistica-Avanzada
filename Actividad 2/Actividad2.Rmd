...
Observamos que el p valor devuelto es superior al alfa definido que es de 0.05 por lo que podemos asumir que la hipóteis nula es cierta y por tanto rechazamos la hipótesis alternativa de que el promedio del salario de lo shombres es al menos 50 euros mayor que el de las mujeres con un 95% de confianza.
